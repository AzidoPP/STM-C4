...
免责声明：
本作品为基于游戏《CS2》中道具外观进行复刻的模型展示品，仅用于学习、展示或收藏用途。
该模型不具备任何实际功能、危险性或现实用途。
任何个人或第三方对本模型进行的改装、滥用、非法使用或其他非预期行为，均与原作者无关，原作者不承担由此产生的任何责任。

Disclaimer:
This work is a replica model based on the appearance of an in-game item from CS2, intended solely for learning, display, or collection purposes.
The model has no real-world functionality, hazardous properties, or destructive capability.
Any modification, misuse, or illegal use by individuals or third parties is not associated with the original creator, who assumes no responsibility for any consequences arising therefrom.
