...
/* Range check / ???? */
/* CONFIG_IGNORE_RANGE: 0 = check ranges, 1 = ignore ranges. / 0=????, 1=???? */
...
/* CONFIG_LCD_COLS: LCD columns / LCD??
...
/* Buzzer / ??? */
/* CONFIG_BUZZER_STARTUP_FREQ_HZ: startup/defuse-success frequency (Hz) / ?????????(Hz)
   Min: 100   Max: 10000  Typical: 4250 */
#define CONFIG_BUZZER_STARTUP_FREQ_HZ 4250U
/* CONFIG_BUZZER_COUNTDOWN_FREQ_HZ: countdown frequency (Hz) / ?????(Hz)
